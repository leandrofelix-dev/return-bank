        ...
        <div className="flex">
          <div className="h-screen w-1/2 flex items-center justify-center flex-col z-20">
            ...
            <div className="flex flex-col w-1/2 mt-14">
              <label htmlFor="beneficiary" className="font-bold text-zinc-800 ml-4 mb-2 text-xl">
                Beneficiário
              </label>
              <input
                type="text"
                name="beneficiary"
                id="beneficiary"
                placeholder="Insira o ID do beneficiário"
                className="p-4 shadow-md shadow-purple-300 bg-purple-200 text-lg rounded-xl font-semibold text-zinc-800 placeholder:text-purple-400 mb-4"/>
              <label htmlFor="value" className="font-bold text-zinc-800 ml-4 mb-2 text-xl">
